...
// Get page content of About us page
$page = mysql_fetch_array(mysql_query("select * from tbl_pages where pageid = 1 "));
...
<div id="wrapper">
  <div id="maincont">
    <div id="illust">
      <div class="clr"></div>
      <div class="chemistry_hd_txt" style="text-align:left; margin-left:50px;"><u><?=ucwords($page['pagetitle']);?></u></div>
