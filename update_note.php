...
$find_user	= mysql_fetch_array(mysql_query("select favor_id from favorites where id = '".$_REQUEST['uid']."' "));
$abc		= mysql_fetch_array(mysql_query("select user_id from user where user_id = '".$find_user['favor_id']."' "));
...
<div id="wrapper">
  ...
  <div class="chemistry_main" style="background:#f1f1f1; margin-top:50px; width:750px;">
    ...
    <div class="clr"></div>
    <div class="chemistry_hd_txt" style="font-size:12px;"><a href="viewprofile.php?profid=<?=$find_user['favor_id'];?>">View Profile</a> <a href="send_msg.php?uid=<?=$abc['user_id'];?>"><img src="images/mail.png" /></a></div>
    <div class="clr"></div>
    <form id="form1" name="form1" method="post" action="">
      <div class="mandatory_flds2">
        <label>
        <textarea name="notes" id="notes"  style="width:500px; height:200px; margin-left:115px;"><?=$query_note['note']; ?></textarea>
        </label>
      </div>
      <div class="clr"></div>
