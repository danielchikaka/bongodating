...
$insertid=trim($_POST['hid']);
	   $esql="update product set
	    p_name='".addslashes($_POST['pname'])."',
	    p_mrp='".trim($_POST['mrp'])."',p_ship_time='".trim($_POST['stime'])."',p_ship_charge='".trim($_POST['scharge'])."',p_detail='".addslashes($_POST['pdetails'])."',status='yes',date1=now() where p_id='".$insertid."'";
...
<input type="text" name="pname" class="txtfield"  size="80" value="<?=stripslashes($res['p_name'])?>" /></td><td width="24%" rowspan="3"><img src="upload/<?=$res['p_img']?>"  width="160" height="120" border="0"/></td></tr>

  <tr valign="middle">
  <td width="17%" align="right" height="19">MRP</td>
  <td width="83%" align="left">
<input type="text" name="mrp" class="txtfield"  size="80"  value="<?=$res['p_mrp']?>"/></td></tr>


  <tr valign="middle">
  <td width="17%" align="right" height="19">Shipping Time</td>
  <td width="83%" align="left">
<input type="text" name="stime" class="txtfield"  size="80" value="<?=$res['p_ship_time']?>" /></td></tr>
  <tr valign="middle">
  <td width="17%" align="right" height="19">Shipping Charges</td>
  <td width="83%" align="left">
<input type="text" name="scharge" class="txtfield"  size="80" value="<?=$res['p_ship_charge']?>" /></td></tr>

 <tr valign="middle">
  <td width="17%" align="right" height="19">Products Details</td>
  <td width="83%" align="left">
<input type="text" name="pdetails" class="txtfield"  size="80" value="<?=stripslashes($res['p_detail'])?>"/></td></tr>
<tr valign="top"><td width="17%" align="right" height="19">
Image
</td>
<td width="83%" align="left">
<input type="file" name="photo1" id="photo1" /><input type="hidden" name="hid" value="<?=$_GET['id'];?>" />
</td></tr>
