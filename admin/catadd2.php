...
if($_REQUEST['btn_save']=="Submit") {
 ...
 $selq="update page page set pname='".$name."',description='".$desc."' where id='2'";
   $selarr = mysql_query($selq);
 $succ="Page Updated successfully"
  ?>
<script>javascript:location.href="user.php?frm=catadd2&err=<?=$err?>"</script>
<?
 }
$sql=mysql_query("select * from page where id='2'");
$res=mysql_fetch_assoc($sql);
?>

<table width="100%" border="0" align="center" cellspacing="1" cellpadding="2">
  <form action="user.php?frm=catadd2" name="frm_email" method="post"  enctype="multipart/form-data">
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="left"><textarea name="pc_TR_body1" rows="25" id="pc_TR_body1" style="width:500px"><?=stripslashes($res['description'])?>
</textarea>
        <script type="text/javascript">
			CKEDITOR.replace( 'pc_TR_body1', { height: 350, width: 670 });
			</script></td>
    </tr>
    <tr valign="middle">
