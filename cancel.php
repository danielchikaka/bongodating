    ...
    <div id="illust">
      <div class="chemistry_main" style="border: medium ridge; margin-top:30px;">
        <div class="chemistry_main" style="background:#f1f1f1;">
          <div class="profl_heading"><strong>Sorry, You have cancled your transaction!</strong></div>
        </div>
        <div class="profl_txt_1"><strong>Please try again.</strong></div>
        <div class="profl_txt_1"><strong>Or Try with another card.</strong></div>
      </div>
      <div class="clr"></div>
    </div>
  </div>
