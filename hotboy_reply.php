...
if(mysql_num_rows($msg_reply)>0)
{
	...
	//member details
	$replyuser_id = mysql_query("select * from user where user_id = '".$rowuser['sender_id']."' and user_gender = 'male' and status = '1'");
...
?>
      <div class="chemistry_main" style="background:#f1f1f1;">
        <div class="profl_txt_1" style="color:#CC0000;"><strong>No Any Boys given reply to your messages!</strong></div>
      </div>
      <?php 
}
}
